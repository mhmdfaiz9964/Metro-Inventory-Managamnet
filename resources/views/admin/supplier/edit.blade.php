...
<div class="container my-5">
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h4 class="mb-0 text-white"><i class="bi bi-pencil-square me-2 text-white"></i>Edit Supplier</h4>
        </div>
        <div class="card-body">
            ...
            <form action="{{ route('admin.suppliers.update', $supplier->id) }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="mobile_number" value="{{ old('mobile_number', $supplier->mobile_number) }}" class="form-control @error('mobile_number') is-invalid @enderror">
