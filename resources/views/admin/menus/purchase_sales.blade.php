...
@section('title', 'Purchase & Sales Management')

@section('content')
<div class="container my-5">
    <h4 class="mb-4">Purchase & Sales Dashboard</h4>
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        <!-- Purchase Section -->
        <div class="col">
            <a href="{{ route('admin.purchases.table') }}" class="text-decoration-none open-modal" data-title="All Purchases">
                <div class="card h-100 shadow-sm d-flex flex-column align-items-center justify-content-center text-center p-3">
        ...
        <div class="col">
            <a href="{{ route('admin.invoices.purchases') }}" class="text-decoration-none open-modal" data-title="Purchase Invoices">
                <div class="card h-100 shadow-sm d-flex flex-column align-items-center justify-content-center text-center p-3">
