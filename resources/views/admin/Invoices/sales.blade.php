        ...
        <div class="card-body">
            ...
            <form method="GET" class="row g-2 mb-3">
                ...
                <div class="col-md-3">
                    <select name="salesperson_id" class="form-select">
                        ...
                        @foreach ($users as $user)
                            <option value="{{ $user->id }}" {{ request('salesperson_id') == $user->id ? 'selected' : '' }}>
                                {{ $user->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-2 d-flex gap-2">
                    ...
                    <a href="{{ route('admin.invoices.sales') }}" class="btn btn-secondary w-100">Clear</a>
                </div>
            </form>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.sales.print', $sale->id) }}" target="_blank" class="btn btn-primary btn-sm">
                                    Print
                                </a>
                            </td>
                        </tr>
