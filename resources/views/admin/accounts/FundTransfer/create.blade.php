...
<div class="container my-5">
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h4 class="mb-0 text-white"><i class="bi bi-plus-circle me-2 text-white"></i>Create Fund Transfer</h4>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.fund-transfers.store') }}" method="POST">
                @csrf
                @include('admin.Accounts.FundTransfer.form', ['fundTransfer' => null])
