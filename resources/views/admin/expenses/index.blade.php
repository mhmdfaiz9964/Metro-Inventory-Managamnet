                ...
                <form method="GET" action="{{ route('admin.expenses.index') }}" class="row g-2 mb-3">
                    <div class="col-md-5">
                        <input type="text" name="search" value="{{ request('search') }}" class="form-control"
                            placeholder="Search by reason or paid by"
                            ...
                            @forelse($expenses as $expense)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif($expense->payment_method === 'Fund Transfer')
                                            <span class="badge bg-primary">Fund Transfer</span>
                                        @elseif($expense->payment_method === 'Cheque')
